...
class FailingSchemaValidationPolicy(AbstractSchemaValidationPolicies):
    def record_passes_validation_policy(self, policy: "AbstractSchemaValidationPolicies", record: Mapping[str, Any], schema: Mapping[str, Any]) -> bool:
        return False
